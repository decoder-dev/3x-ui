...
export const AllSettingSchema = z
  .object({
    ...
    subAnnounceUrl: z.string().optional(),
    subChangeUserAgent: z.boolean().optional(),
    subNoLimitXhttp: z.boolean().optional(),
    subHappFingerprint: z.string().optional(),
    subUserAgent: z.string().optional(),
    subUserAgentGeoFiles: z.string().optional(),
