...
export const AllSettingSchema = z.object({
  ...
  subAnnounceUrl: z.string(),
  subCertFile: z.string(),
  subChangeUserAgent: z.boolean(),
  ...
  subUserAgent: z.string(),
  subUserAgentGeoFiles: z.string(),
