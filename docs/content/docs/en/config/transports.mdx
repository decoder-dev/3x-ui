...
| `scStreamDownServerSecs` | _(none)_  | Downlink framed keepalive window on server (decoder-dev / #6562).      |
| `downFrame`            | `false`     | Client requests framed downlink keepalive (client extra / decoder-dev). |
